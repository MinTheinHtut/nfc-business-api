...
function fields(body, creating = false) {
  ...
  if (username.length > 100) errors.username = 'Username must be 100 characters or fewer';
  if (fullName.length > 255) errors.full_name = 'Full name must be 255 characters or fewer';
  if (email && email.length > 255) errors.email = 'Email must be 255 characters or fewer';
  if (password.length > 256) errors.password = 'Password must be 256 characters or fewer';
